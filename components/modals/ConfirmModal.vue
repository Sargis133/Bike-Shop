          ...
          <slot name="footer">
            ...
            >
              <slot name="footer-content">
                <ui-ui-button variant="success" size="sm" @click.stop="emitAnswerFunc">
                  {{ props.buttons?.at(0) || "Yes" }}
                </ui-ui-button>

                <ui-ui-button variant="light" size="sm" @click.stop="closeModalFunc">
                  {{ props.buttons?.at(1) || "No" }}
                </ui-ui-button>
              </slot>
            </div>
          </slot>
